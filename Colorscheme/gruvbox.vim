...
hi CursorLine         guibg=#282828      guifg=#ffffff     gui=bold
hi CursorLineNr       guibg=NONE         guifg=#ffffff     gui=bold gui=bold
hi String             guibg=NONE         guifg=#d65d0e
hi Identifier         guibg=NONE         guifg=#458588
hi Comment            guibg=NONE         guifg=#d5c4a1
hi LineNr             guibg=NONE         guifg=#504945
hi Search             guibg=#427b58      guifg=#ffffff
...
hi StatusLine         guibg=#fbf1c7      guifg=#17191a
...
hi Type               guibg=NONE         guifg=#fabd2f
